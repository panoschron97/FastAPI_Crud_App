...
p4 = information(id = 4, firstname = "UnKnownFirstName", lastname = "UnKnownLastName", age = 80, sex = "M", datebirth = datetime.datetime.strptime("1945-01-01", "%Y-%m-%d"), jobstatus = False, levelofeducation = "N/A", salary = 0.0)
